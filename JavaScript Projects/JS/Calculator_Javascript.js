//creates an object to track of values
const Calculator={
...
//this function updates the calculator screen with the contenets of display_value
...
keys.addEventListener('click',(event)=>{
  ...
  //ensures that ac LEARS ALL LINPUTS FROM THE CALCULATOR SCREE
